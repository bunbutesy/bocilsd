...
A live demo of the project is available at [https://bocilsd.pages.dev](https://bocilsd.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bocil sd`)
...
1. Fork the [repository](https://bunbutesy/bocilsd/bokepbocilsmp/fork) on GitHub.
