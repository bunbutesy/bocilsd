...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bocilsd.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'NpayDIkiC7Ex2VkbGooVVr0AFkzwTeKfQDx-dORsCJw',
        yandex: 'fa336d98bcc4adcd',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "url": "https://bocilsd.pages.dev",
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "image": "https://bocilsd.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bocilsd.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bocilsd.pages.dev/?q={search_term}", 
